...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        if len(pred) == 0:
            # draw "no image detected" on the image
            cv2.putText(im0, "No image detected", (20, 70), cv2.FONT_HERSHEY_PLAIN, 2, (0,255,0),2)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det)==0:
                cv2.putText(im0, "Sorry!!. I Cannot Detect any Person", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2, cv2.LINE_AA)
